...
public class ScannerResultImageSnippetTrackDto extends AbstractDto {
	private Long id_scanner_result_image_snippet;
	...
	public ScannerResultImageSnippetTrackDto() {
		super();
	}
	...
	public Long getId_scanner_result_image_snippet() {
		return id_scanner_result_image_snippet;
	}

	public void setId_scanner_result_image_snippet(Long id_scanner_result_snippet) {
		this.id_scanner_result_image_snippet = id_scanner_result_snippet;
	}
	...
	public String toString() {
		return "ScannerResultSnippetTrackDto [id_scanner_result_image_snippet=" + id_scanner_result_image_snippet + ", page=" + page
