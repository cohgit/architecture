...
/**
 * Abstract class parent of all report generators.
 */
import java.io.File;
...
public abstract class AbstractReportGenerator {
	...
	public AbstractReportGenerator(Logger log, String jasperTemplate, ReportParams parameters) {
		super();
		this.log = log;
		this.jasperTemplate = jasperTemplate;
		this.parameters = parameters;
	}
	public AbstractReportGenerator(Logger log) {
		super();
		this.log = log;
	}
...
//	    	exporter.exportReport();
		...
		try {
			...
			if (filePath != null) {
				if (this.parameters.isToEmail()) {
					this.sendNotifications(filePath);	
				}
	 ...
	 */
	protected abstract void sendNotifications(String fileReportPath);
