...
import cl.atianza.remove.helpers.reports.beans.ChartElement;
import cl.atianza.remove.helpers.reports.beans.ChartPieElement;
import cl.atianza.remove.helpers.reports.beans.FeelingCounter;
import cl.atianza.remove.helpers.reports.beans.KeywordFeelingCounter;
import cl.atianza.remove.helpers.reports.beans.TableRemoveImpulseRow;
import cl.atianza.remove.helpers.reports.beans.TableResults;
import cl.atianza.remove.helpers.reports.beans.TableRow;
import cl.atianza.remove.helpers.reports.beans.TrackingWordBean;
...
public class ReportScannerGeneratorMonthly extends AbstractReportGeneratorMontlhy{
	 private final String KEY_PARAM_FILTER_USER_UUID = "KEY_PARAM_FILTER_USER_UUID";
	    ...
	    public ReportScannerGeneratorMonthly(Logger log, String jasperTemplate, ReportParams parameters) {
	    ...
	    public static ReportScannerGeneratorMonthly init(String template, ReportParams parameters) {
	        return new ReportScannerGeneratorMonthly(LogManager.getLogger(ReportScannerGenerator.class), template, parameters);
	    }
...
//	    			list.add(new ChartElement(timelineLabel, snippetId, track.getDate_scan().toLocalDate(), track.getPosition()));
	     ...
	     */
	    @Override
	    protected void sendNotificationsMontlhy(String filePath) {
	        try {
	        	Map<String, String> tokens = new HashMap<String, String>();
	        	tokens.put("{{SCANNER_NAME}}", scanner.getName());

	            EmailReportHelper.init().sendReportEmailMonthly(languageNotification,
