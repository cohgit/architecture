...
public class TestDeindexationFormCreator {
	public void createVersionOne() throws RemoveApplicationException {
	...
	private void createGoogleResults(DynamicForm form) {
		...
		List<DynamicFormConditionResult> googleResults = Arrays.asList(
				...
				createConditonResult(
						...
						""),
				createConditonResult(
						"IS_FAKE_INFO AND IS_FAVORABLE_JUDGMENT", 
