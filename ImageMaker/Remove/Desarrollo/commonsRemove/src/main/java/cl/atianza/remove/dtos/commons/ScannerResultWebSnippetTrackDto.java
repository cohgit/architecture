...
public class ScannerResultWebSnippetTrackDto extends AbstractDto {
	...
	public ScannerResultWebSnippetTrackDto() {
		super();
	}
	...
	public void setId_scanner_result_web_snippet(Long id_scanner_result_snippet) {
		this.id_scanner_result_web_snippet = id_scanner_result_snippet;
	}
	...
	public String toString() {
		return "ScannerResultSnippetTrackDto [id_scanner_result_web_snippet=" + id_scanner_result_web_snippet + ", page=" + page
