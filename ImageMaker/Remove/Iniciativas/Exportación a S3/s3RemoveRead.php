...
$objectKey = 'prod-02-2023-10-19-23-11/remove_prd/remove.scanners_results_web_snippets_tracks/1/part-00001-453b4abc-a9f9-4a20-8f6d-f2857764bc98-c000.gz.parquet';
#$objectKey = 'prod-02-2023-10-19-23-11/remove_prd/remove.scanners_results_web_snippets_tracks/1/part-00000-453b4abc-a9f9-4a20-8f6d-f2857764bc98-c000.gz.parquet';
...
$dataFields = $parquetReader->schema->GetDataFields();
 ...
 for($i = 0; $i < $parquetReader->getRowGroupCount(); $i++)
 {
    ...
    $data = $columns[0]->getData();//." ".$columns[1]->getData();
